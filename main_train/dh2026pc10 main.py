...
from os import path
from segmentation_models_pytorch.losses.jaccard import JaccardLoss, MULTICLASS_MODE
...
CRITERION = JaccardLoss(mode=MULTICLASS_MODE)
...
for image in EVALUATION_IMAGES:
    img_dir = "/virtual/drosari3/data_v12"
